...
<body>
    ...
    <section class="hero">
        <div class="hero-content">
            <h1>Winter Collection in 2025 - ver4</h1>
            <p>Discover the latest trends in fashion, technology , clothing and accessories with up to 50% off selected items on winter collection</p>
